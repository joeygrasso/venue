      ...
      <div class="container mainContainer">
        ...
        <div class="row">
          ...
          <div class="col-md-9" style="border-left: 1px solid; border-color: #443266;">
            <h2 id="dashboard-h2">Welcome, <?php echo $_SESSION["sess_username"]; ?></h2>
            <hr />
            <p class="lead">Manage Account:</p>
            <p>To change a setting type the new value in the corresponding input field.</p>
              <form role="form"  id ="theform"  method="post" action="./includes/php/updateAccount.php">
                  <?php include './includes/php/userInfo/getAccount.php' ?>
