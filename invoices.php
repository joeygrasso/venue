      ...
      <div class="container mainContainer">
        ...
        <div class="row">
          ...
          <div class="col-md-9" style="border-left: 1px solid; border-color: #443266;">
           	<h2 id="dashboard-h2">Reservation Invoices</h2>
            <hr />
            <p>Click a reservation ID number to bring up the appropriate invoice.</p>
            <div class="table-responsive">
              <table class="table table-hover">
                <?php include './includes/php/userInfo/getInvoiceLinks.php'; ?>
              </table>
            </div>
          </div>
      </div><!-- /.container -->
